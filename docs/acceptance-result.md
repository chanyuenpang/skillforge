...
| C6 provenanceSummary 口径 | PASS | `docs/roadmap.md`、`docs/runtime-replay-protocol-lightweight-design.md` 同步声明 `metadata.provenanceSummary` 为 disclosure/informational only | 仅说明来源，不参与 decision，不代表真实 provider execution |
