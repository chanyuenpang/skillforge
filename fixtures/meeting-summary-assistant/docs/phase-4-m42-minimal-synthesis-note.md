...
This is a contract sample only. It is static-only and is designed to show the minimal static shape that can be validated without asserting runtime success.
